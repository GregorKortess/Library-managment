...
class BookCheckoutTest extends TestCase
{
    ...
    /** @test */
    public function only_a_real_book_can_be_check_out()
    {
        $this->actingAs($user = Factory(User::class)->create())
            ->post('/checkout/123')
            ->assertStatus(404);
    ...
    /** @test */
    public function only_signed_in_users_can_check_ib_a_book()
    {
        $book = factory(Book::class)->create();
    ...
    /** @test */
    public function a_404_is_thrown_if_a_book_is_not_check_out_first()
    {
        $book = factory(Book::class)->create();
        $user = Factory(User::class)->create();
